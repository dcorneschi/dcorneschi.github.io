...
| [EKS EC2 Tags vs Node Selectors and Instance-Based Draining](articles/eks-ec2-tags-vs-node-selectors.md) | Self-managed nodes — how EC2 tags differ from Kubernetes labels, why draining targets instance IDs, and Node Termination Handler. |
| [EKS Node Group Rolling Updates](articles/eks-node-group-rolling-updates.md) | How EKS recycles nodes when a launch template changes — rolling update strategy, PDB handling, force updates, and Terraform per-AZ workflow. |
